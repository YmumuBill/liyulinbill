                    ...
                    <div class="col-sm-10">
                        <ul class="quxian">
                            <?php if(is_array($lists)): foreach($lists as $key1=>$item1): ?><li class="first">
                                    <label><input type="checkbox" class="first" value="<?php echo ($item1["id"]); ?>"><?php echo ($item1["title"]); ?></label>
                                    <ul class="second">
                                        <?php if(is_array($item1["_child"])): foreach($item1["_child"] as $key2=>$item2): ?><li>
                                                <label><input type="checkbox" class="second" value="<?php echo ($item2["id"]); ?>"><?php echo ($item2["title"]); ?></label>
                                                <ul class="third">
                                                    <?php if(is_array($item2["_child"])): foreach($item2["_child"] as $key3=>$item3): ?><li> <label><input type="checkbox" class="third" value="<?php echo ($item3["id"]); ?>"><?php echo ($item3["title"]); ?></label></li><?php endforeach; endif; ?>
                                                </ul>
    ...
    $(function(){
        ...
        $("#save-conf").click(function(){
            ...
            $.ajax({
                ...
                data: {"title":name,"rules":roles,"ajax":1},
                type:"POST",
                dataType: "json",
