...
<style>
    .ibox{margin: 10px;border: 1px solid #ccc;  box-shadow: 0 1px 0 #e5e5e5;}
</style>
<div id="body">
        ...
        <div class="ibox-content">
            <form class="form-horizontal form-row-border" action="" method="post" proxy="auto" novalidate="">
                    ...
                    <div class="col-md-9 form-fieldset">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 form-inline" id="birthdaySelect" role="date-select">
                                <input type="text" name="birthday" class="mobiscroll_time" value="">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="specialty" title="擅长项目" value="" placeholder="输入擅长项目" validator="maxLength(150)" maxlength="150">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <button class="btn btn-default" type="button" id="addAwardButton">
                            <i class="fa fa-plus"> 添加一项</i>
                        </button>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="save_figure_btn">
                        <div rel="save">保存</div>
                        <a href="/m.php?m=Admin&c=figures&a=index" onclick="location.href='/m.php?m=Admin&c=figures&a=index'">取消</a>
                    </div>
                </div>
            </form>
        </div>
